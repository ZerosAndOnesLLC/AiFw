//! The detection engine: runs a decoded packet through flow tracking,
//! protocol parsing, the Aho-Corasick prefilter, and per-rule evaluation
//! (content, PCRE, address/port, flow, threshold, flowbits) to produce
//! alerts.
...
use crate::rules::{CompiledRule, FlowConstraint, FlowbitOp, RuleDatabase};
