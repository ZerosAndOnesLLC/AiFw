    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-lg p-6">
        ...
        <div className="space-y-5">
          ...
          {/* Save (when dirty) + Apply / Validate (always — DB state can drift
              from live applied state, so the user must always be able to
              re-apply or validate the persisted config). */}
