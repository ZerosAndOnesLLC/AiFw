...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Is AiFw production-ready?", "acceptedAnswer": { "@type": "Answer", "text": "No. AiFw is beta software under active development. Consult the feature maturity matrix and validate the exact release in your environment before deployment." } },
...
No. AiFw is beta software under active development. Control-plane coverage does not necessarily mean a complete or functionally tested FreeBSD data plane. Consult the [feature maturity matrix]({{ '/maturity/' | relative_url }}) and validate the exact release in your environment before deployment.
