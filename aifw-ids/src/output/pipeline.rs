//! The alert output surface: the `AlertOutput` backend trait and the
//! fan-out `AlertPipeline` that dispatches each alert to every configured
//! output.
