...
// (CreateNatRuleRequest moved to routes/nat.rs, CreateRuleRequest moved
//  to routes/rules.rs, DnsConfig* moved to routes/dns.rs, etc. — #187)

// StaticRoute, CreateRouteRequest, SystemRoute moved to routes/static_routes.rs (#187)
...
// --- Rules CRUD has moved to routes/rules.rs (#187). ---
