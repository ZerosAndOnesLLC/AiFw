...
import type { UdpService } from "@/lib/api/reverse-proxy/udp";

interface ServicesSectionProps {
  services: UdpService[];
  onAdd: () => void;
  onEdit: (service: UdpService) => void;
  onDelete: (id: string) => void;
}

export function ServicesSection({ services, onAdd, onEdit, onDelete }: ServicesSectionProps) {
  return (
    <section>
